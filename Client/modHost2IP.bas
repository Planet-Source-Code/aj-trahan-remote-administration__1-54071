...
Public Function GetHostNamez(ByVal Address As Long) As String
    ...
    If lRet <> 0 Then
        ...
        If lLength > 0 Then
            ...
            CopyMemory ByVal GetHostNamez, ByVal lRet, lLength
        End If
    Else
        GetHostNamez = "No Host Found"
    End If
    SocketsCleanup
End Function
